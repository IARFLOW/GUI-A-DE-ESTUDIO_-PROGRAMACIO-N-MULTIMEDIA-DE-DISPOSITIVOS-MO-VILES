...
### Concepto de Fragment y ciclo de vida de Fragment
...
### Conexión a servicios REST usando OkHttp
...
Veamos cómo integrarlo en un ejemplo.

### Ejercicio práctico: Consumiendo un servicio REST de películas
...
- Al clicar "Cargar Películas":
  ...
  - onResponse failure: ocultamos## Unidad 5 – Persistencia de Datos en Android
...
### SharedPreferences: Preferencias y configuraciones sencillas
...
### Archivos internos (Internal Storage)
...
### SQLiteOpenHelper: Base de datos SQLite integrada
...
### Introducción a Room (ORM de Android)
...
### Ejercicio práctico: CRUD de Contactos
...
## Unidad 6 – Permisos, Depuración y Publicación de Apps
...
### Permisos en Android: Declaración y Solicitud en tiempo de ejecución
...
### Depuración: Logcat, breakpoints y técnicas
...
**¡Felicidades!** Has llegado al final de esta guía didáctica de PMDM. Repasa cada unidad, practica los ejemplos, intenta los mini-tests y explora los proyectos de `/proyectos_demo` para ver el código completo en contexto. Con dedicación y práctica, llegarás muy bien preparado al examen de junio. ¡Mucho ánimo y éxito en tu aprendizaje de desarrollo Android!
